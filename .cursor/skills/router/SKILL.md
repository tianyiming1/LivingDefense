...
description: >
  ...
  shipping (game jam, Steam, itch). Also routes asset folder architecture / dedupe
  (`asset-architecture`). Start here
...
| "整理重复像素图 / 理清 assets/pixels 目录" | Godot | `asset-architecture`（先于出图） |
